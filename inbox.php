        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-01">
                <ul class="nav navbar-nav">
                    <li><a href="friend-list.php"><i class="fa fa-group"></i></a></li>
                    <li class="active"><a href="inbox.php"><i class="fa fa-envelope"></i> Inbox</a>
                    </li>
        ...
        <div class="col-md-6 padding-20">
            <div class="row">
                <div class="col-md-12 padding-10">
                    ...
                    //echo $msg->sender;
                    $stmt = $msg->getMessagesGroupBySender();
                    $stmt->bind_result($id, $recipient, $sender, $messages);
                    while ($stmt->fetch()) {
                        ?>
                        <div class="col-md-12 bg-cloud margin-bottom">
                            <h6>Messages from <a href="#" class="text-info"><? echo $sender ?></a></h6>
                            <p><a href="detail-messages.php?sender=<? echo $sender ?>">read messages</a></p>
