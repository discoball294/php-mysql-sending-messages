            ...
            <div class="row">
                <div class="col-md-12 padding-10">
                    <div class="col-md-12 bg-cloud margin-bottom">
                        <h6>Send to : <a href="#" class="text-info"><? echo $_GET['recipient'] ?></a></h6>
                        <h6>Messages</h6>
                        <form action="action.php?act=send-messages&sender=<?echo $_SESSION['username'] ?>&recipient=<? echo $_GET['recipient'] ?>" method="post">
                            <textarea name="messages" class="form-control"></textarea><br>
                            <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-paper-plane"></i> Send</button>
                        </form>
                        <br>
                    </div>
                </div>
                <div class="col-md-12 padding-10">
                    ...
                    while ($stmt->fetch()) {
                        ?>
                        <div class="col-md-12 bg-cloud margin-bottom">
                            <h6><a href="#" class="text-info"><? echo $_SESSION['nama'] ?></a> > <a href="#" class="text-info"><? echo $_GET['recipient'] ?></a></h6>
                            <p><? echo $messages ?></p>
                        </div>
                        <?
                    }
